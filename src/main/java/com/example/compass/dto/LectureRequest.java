...
public class LectureRequest {
	...
	public LectureRequest(@NotBlank(message = "Title is required") String title,
			...
			@NotNull(message = "Lecture order is required") @Min(value = 1, message = "Lecture order must be at least 1") Integer lectureOrder,
	...
	public void setLectureOrder(Integer lectueOrder) {
		this.lectureOrder = lectueOrder;
	}
